			...
			<div className={style.inner + ' container'}>
				...
				<div className={style.header}>
					...
					<div className={style.buttons}>
						<button>
							<svg width='64px' height='64px' viewBox='0 0 24 24' stroke='#fff' xmlns='http://www.w3.org/2000/svg' transform='rotate(90)'>
								<g id='SVGRepo_bgCarrier' stroke-width='0'></g>
								<g id='SVGRepo_tracerCarrier' stroke-linecap='round' stroke-linejoin='round'></g>
								<g id='SVGRepo_iconCarrier'>
									<path d='M12 6V18M12 6L7 11M12 6L17 11' stroke-width='1' stroke-linecap='round' stroke-linejoin='round'></path>
								</g>
							</svg>
						</button>
						<button>
